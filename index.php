...
<head>
    ...
    <link rel="stylesheet" href="dist/css/lobby.css">
    ...
    <div class="container-fluid">
        <header class="row align-items-center">
            <div class="col-12 d-flex justify-content-end p-3">
                <a href="dist/views/login.php" class="btn btn-dark">Iniciar Sesión</a>
            </div>
        </header>
    </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                    <img class="logo img-fluid p-2" src="dist/assets/img/logo.png" alt="¿Y esa Pregunta?">
                </div>
            </div>
            <div class="container-body row justify-content-center">
                <div class="col-10 col-sm-6 col-md-4 col-lg-3 bg-white p-4 rounded shadow">
                    <form action="dist/views/procesar_pin.php" method="post">
                        <div class="mb-2">
